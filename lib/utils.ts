...
export function getFileIcon(
  ...
  switch (extension) {
    ...
    case "zip":
    case "gz":
      return "/assets/icons/file-archive.svg";
...
export function convertFileSize(sizeInBytes: number, digits?: number) {
  if (sizeInBytes < 1024) {
...
export function calculatePercentage(sizeInBytes: number) {
...
export function constructDownloadUrl(bucketFileId: string) {
...
export function getFileTypesParams(type: string) {
  switch (type) {
    case "documents":
      return ["document"];
    case "images":
